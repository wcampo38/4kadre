<footer class="footer py-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-2 text-center text-md-start">
                <img src="image/4Kadres_logo_v2.png" alt="4Kadre Logo" class="logo mb-3">
                <p class="mb-1"><strong>Contact</strong></p>
                <p class="mb-0">07123456789</p>
                <p>contact@4kadre.com</p>
                <div class="d-flex gap-3 mt-2 justify-content-center justify-content-md-start">
                    <a href="#" target="_blank" class="footer-icon"><i class="bi bi-instagram"></i></a>
                    <a href="#" target="_blank" class="footer-icon"><i class="bi bi-tiktok"></i></a>
                </div>
            </div>
    ...
    <div class="footer-bottom text-center py-3 mt-3">
        <p>&copy; Copyright 4kadre bla bla bla</p>
    </div>
</footer>